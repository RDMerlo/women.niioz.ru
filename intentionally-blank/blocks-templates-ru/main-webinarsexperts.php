...
<section class="page-section" id="businessprogram"  style="padding-top: 60px;">
    <div class="container">
        ...
        <h1 class="section-title">
            <?$sTitle = get_field('title_ru', 1743);?>
        ...
        <div data-animation="fadeInUp" data-animation-delay="300">
            ...
            <!-- Блок семинаров -->
            <?
            $arSeminars = CFS()->get('seminars', 1743);
            if ($arSeminars):
                    ...
                    <div class="media-body">
                        <div class="post-header">
                            <div class="post-meta row">
                                ...
                                <div class = "col-lg-2">
                                    <button type="button" class="btn btn-theme btn-block btn-primary" data-toggle="modal" data-target="#exampleModalCenter-2">Трансляция</button>
                                </div>
                            </div>

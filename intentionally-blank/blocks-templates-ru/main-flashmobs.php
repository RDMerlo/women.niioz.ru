<?php
$sTitle = get_field('title_ru', 1736);
$sContent = get_field('content_ru', 1736);
?>
<section class="page-section white-bg" id="flashmobs" style="padding-top: 30px">
    <div class="container">
        ...
        foreach( $result as $post ):
            ...
            if($arCategories[0]->name !== 'Для блока флешмобов'){
                continue;
            }
            ?>
            <div class="news-item">

            ...
            <div class="col-md-4">
                <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="100">
                    <div class="post-media">
                        ...
                        <img src="<?php echo ASSETSURI?>img/preview/recent-post-1.jpg" alt=""/>
                    </div>
            ...
            <div class="col-md-4">
                <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="300">
                    <div class="post-media">
                        ...
                        <img src="<?php echo ASSETSURI?>img/preview/recent-post-2.jpg" alt=""/>
                    </div>
                    <div class="post-header">
                        <h2 class="post-title"><a href="#">Standart Blog Post Header Here</a></h2>
                        <div class="post-meta">
            ...
            <div class="col-md-4">
                <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="500">
                    <div class="post-media">
                        ...
                        <img src="<?php echo ASSETSURI?>img/preview/recent-post-3.jpg" alt=""/>
                    </div>
                    <div class="post-header">
                        <h2 class="post-title"><a href="#">Standart Blog Post Header Here</a></h2>
                        <div class="post-meta">
